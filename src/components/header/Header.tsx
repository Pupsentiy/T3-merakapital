...
const Header: FC = () => {
  ...
  const { reqNumber } = useTypedSelector((state) => state.data);
        ...
        <div className={styles.button__container}>
          <div>
            <div aria-label="Theme toggle">
              <button
                className={
                  theme === "dark" ? styles.button__light : styles.button__dark
                }
              ...
              <button
                className={
                  theme === "light" ? styles.button__light : styles.button__dark
                }
